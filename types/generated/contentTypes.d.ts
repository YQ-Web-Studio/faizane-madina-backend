...
export interface ApiTimetableTimetable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    prayerData: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    timetableImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiWeeklyEventWeeklyEvent extends Struct.CollectionTypeSchema {
  collectionName: 'weekly_events';
  info: {
    displayName: 'Weekly Event';
    pluralName: 'weekly-events';
    singularName: 'weekly-event';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['madrasa-younger', 'madrasa-older', 'ijtimah', 'jummah', 'other']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::weekly-event.weekly-event': ApiWeeklyEventWeeklyEvent;
